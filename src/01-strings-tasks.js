...
function getRectangleString(width, height) {
  ...
  for (let i = 0; i < height; i += 1) {
    for (let j = 0; j < width; j += 1) {
      ...
      else if (i === 0 && j === width - 1) rectangle += '┐';
      else if (i === height - 1 && j === 0) rectangle += '└';
      else if (i === height - 1 && j === width - 1) rectangle += '┘';
      else if (i === 0 || i === height - 1) rectangle += '─';
      else if (j === 0 || j === width - 1) rectangle += '│';
      else rectangle += ' ';
      if (j === width - 1) rectangle += '\n';
    }
  }
  return rectangle;
}
